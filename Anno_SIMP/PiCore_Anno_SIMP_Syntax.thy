...
theory PiCore_Anno_SIMP_Syntax 
...
syntax
  ...
  "_Event"     :: "['a, 'a, 'a] \<Rightarrow> ('l,'k,'s,'prog) event" ("(EVENT _ WHERE _ THEN _ END)" [0,0,0] 61)
  "_Event2"     :: " ['a, 'a] \<Rightarrow> ('l,'k,'s,'prog) event" ("(EVENT _ THEN _ END)" [0,0] 61)
